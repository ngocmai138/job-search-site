	...
	<c:if test="${user.status == 0}">
		<div class="container-fluid" style="text-align: center">
			...
			<div th:if="${comfirm_await}"
				style="width: 600px; height: 400px; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.4) 0px 0px 10px; margin: 20px auto; padding: 15px">
				<p style="line-height: 35px; font-size: 16px">
					Xin chào, <span th:text="${user.userName}"></span> .Bạn đã gửi yêu
									...
									<div class="p-4 p-md-5 border rounded" method="post">
										...
										<div class="form-group">
											<label for="job-location">Địa chỉ</label> <input type="text"
												name="address"
												th:value="${user.address != null ? user.address : null}"
										...
										<div class="form-group">
											<label for="job-location">Số điện thoại</label> <input
												...
												th:value="${user.phoneNumber != null ? user.phoneNumber : null}"
												class="form-control" id="job-location" required
												placeholder="+ 84">
										</div>
										<div class="form-group">
											...
											<textarea name="description"
												th:text="${user.description != null ? user.description : null}"
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<br> <label class="btn btn-primary btn-md btn-file">
										Chọn logo<input type="file" name="file" id="fileUpload2"
										required hidden>
									</label>
									<div id="divLogo">
										<c:choose>
