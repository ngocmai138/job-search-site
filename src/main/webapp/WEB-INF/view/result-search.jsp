                    ...
                    <div class="col text-center">
                        <div class="block-27">
                            ...
                            <c:if test="${pagePrev>0 }">
                                <li ><a href="${pageContext.request.contextPath}/recruitment/searchTitle?keySearch=${keySearch}&pageNumber=${pagePrev}&pageSize=${pageSize}">&lt;</a></li>
                            </c:if>
                            <c:forEach var="i" begin="1" end="${totalPages }">
                                    <li class="${pageNumber == i  ? 'active' : ' ' }">
                                    <a href="${pageContext.request.contextPath}/recruitment/searchTitle?keySearch=${keySearch}&pageNumber=${i}&pageSize=${pageSize}">${i }</a></li>
                            </c:forEach>
                               
                                <c:if test="${pageNext <= totalPages }">
                                <li><a href="${pageContext.request.contextPath}/recruitment/searchTitle?keySearch=${keySearch}&pageNumber=${pageNext}&pageSize=${pageSize}">&gt;</a></li>
                                </c:if>
                            </ul>
                        </div>
                    </div>
